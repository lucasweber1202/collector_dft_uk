"""Runtime settings for collector_dft_uk."""
...
USER_AGENT = os.getenv("COLLECTOR_USER_AGENT", "collector_dft_uk/0.1 (+https://github.com/lucasweber1202/collector_dft_uk)")
